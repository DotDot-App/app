...
class FormTableViewCell: UITableViewCell, UITextFieldDelegate {
    ...
    private var model: PersonalEditFormModel?
    ...
    public func configure(with model: PersonalEditFormModel) {
        self.model = model
    ...
    override func layoutSubviews() {
        ...
        field.frame = CGRect(x: formLabel.right + 5, y: 0, width: contentView.width - 15 - formLabel.width, height: contentView.height)
    }
